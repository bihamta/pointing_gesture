...
def hand_ave_pose_callback(data):
    global glove, glass, hand_ave, face_ave, summ, counter, cam_roll, cam_pitch, cam_yaw, vicon_yaw_deg, vicon_pitch_deg
#    global hand_ave
    hand_ave = data
...
#    sum = 0
#    counter = 0
    if (hand_ave == None or face_ave == None or vicon_yaw_deg == None or vicon_pitch_deg == None):
      print ("no data")
      return
#
    print ("calculation")
...
#print "----------------------------------------------------------------------"
#print " "
     if ( face_ave_yaw_deg != None ):
#    print "Vicon Yaw: " , vicon_yaw_deg, "Vicon Pitch: " , vicon_pitch_deg
       print math.fabs(face_ave_yaw_deg - vicon_yaw_deg), ", ", math.fabs(face_ave_pitch_deg - vicon_pitch_deg) 
...
def hand_med_pose_callback(data):
    global hand_med
    hand_med = data
#    global glove, glass, hand_med, face_med, summ, counter, cam_roll, cam_pitch, cam_yaw, vicon_yaw_deg, vicon_pitch_deg
#    global hand_ave
#    hand_med = data
...
#    sum = 0
#    counter = 0
#    if (hand_med == None or face_med == None or vicon_yaw_deg == None or vicon_pitch_deg == None):
#      print ("no data")
#      return
...
#    global glove, glass, hand_ave_dbscan, face_ave_dbscan, summ, counter, cam_roll, cam_pitch, cam_yaw, vicon_yaw_deg, vicon_pitch_deg
...
#      return
#
#    if (hand_ave_dbscan == None or face_ave_dbscan == None or vicon_yaw_deg == None or vicon_pitch_deg == None):
#      print ("no data")
#      return
#
#   
...
def vicon_camera_callback(data):
    global camera, cam_roll, cam_pitch, cam_yaw, vicon_yaw_deg, vicon_pitch_deg
    camera = data
